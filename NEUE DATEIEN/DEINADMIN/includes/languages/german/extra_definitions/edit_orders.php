...
define('EO_ZC156_FA_ICON', '<div class="fa-stack fa-lg edit"><i class="fa fa-circle fa-stack-2x base"></i><i class="fa fa-wrench fa-stack-1x overlay" aria-hidden="true" title="mit EDIT ORDERS bearbeiten"></i></div>');
