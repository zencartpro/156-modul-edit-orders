...
define('EMAIL_TEXT_COMMENTS_TRACKING_UPDATE', '<em>Die Artikel Ihrer Bestellung werden bald verschickt werden!</em>');
...
define('EO_SHIPPING_TAX_DESCRIPTION', 'enthaltene MwSt. %s%%');
