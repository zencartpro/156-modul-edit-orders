...
// modified for Zen Cart German 2020-10-03 20:42:05 webchills
//
if (!defined('IS_ADMIN_FLAG')) {
    die('Illegal Access');
}

define('EO_CURRENT_VERSION', '4.5.4');
...
$db->Execute (
            "REPLACE INTO " . TABLE_CONFIGURATION_LANGUAGE . " 
             (configuration_title, configuration_key, configuration_language_id, configuration_description, last_modified, date_added) 
             VALUES 
            ('Edit Orders Datei fehlt', 'EO_INIT_FILE_MISSING', '43', 'Dieser versteckte Wert wird auf 1 gesetzt, falls Edit Orders entdeckt, dass benötigte Dateien fehlen.', now(), now())"
    );
